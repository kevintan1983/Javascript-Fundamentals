...
<p>當堆疊裡面為空時， Event Loop 會將佇列裡的訊息抽出並執行回呼的函式，此時堆疊裡面會產生一個與該函式相關的堆疊框架，函式執行完畢後，堆疊框架就會從堆疊裡被移除，圖解方式如下<a href="#fn:eventloop2" id="fnref:eventloop2" title="See footnote" class="footnote">2</a>。</p>
